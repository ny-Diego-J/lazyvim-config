...
-- Helper to check if a plugin is configured in lazy.nvim
...
return {
    ...
    -- defer actually starting it to our configuration of nvim-jdtls below.
    {
        ...
        config = function(_, opts)
            ...
            local function attach_jdtls()
                ...
                local config = extend_or_override({
                    ...
                    capabilities = has("blink.cmp") and require("blink.cmp").get_lsp_capabilities() or has(
                        "cmp-nvim-lsp"
